...
python3 -m pip install -r ./requirements-artic.txt
...
<!-- --read-file ./results/mpox/hostile/SRR21755837_1.clean_1.fastq.gz  -->
...
<!-- ./results/mpox/trim_galore/SRR21755837_1.clean_1_val_1.fq.gz \ -->
<!-- ./results/mpox/trim_galore/SRR21755837_2.clean_2_val_2.fq.gz | \ -->
...
<!-- # 2. Trim alignments from the amplicon scheme

artic-tools align_trim \
    -b ./results/mpox/bwa/alignment/SRR21755837.sorted.bam \
    --normalise 200 \
    --start \
    --minMAPQ 35 \
    --report ./results/mpox/primer-trimmed/SRR21755837.alignreport.txt \
    ./results/mpox/primerschemes/yale-mpox/2000/v1.0.0-cladeii/primer.bed > \
    ./results/mpox/primer-trimmed/SRR21755837.trimmed.rg.bam


samtools sort \
    -T SRR21755837 \
    ./results/mpox/primer-trimmed/SRR21755837.trimmed.rg.bam \
    -o ./results/mpox/primer-trimmed/SRR21755837.trimmed.rg.sorted.bam


samtools index \
    ./results/mpox/primer-trimmed/SRR21755837.trimmed.rg.sorted.bam


artic-tools align_trim \
    -b ./results/mpox/primer-trimmed/SRR21755837.trimmed.rg.sorted.bam \
    --remove-incorrect-pairs \
    --report ./results/mpox/primer-trimmed/SRR21755837.alignreport.txt \
    --primerScheme ./results/mpox/primerschemes/yale-mpox/2000/v1.0.0-cladeii/primer.bed > \
    ./results/mpox/primer-trimmed/SRR21755837.primertrimmed.rg.bam

samtools sort \
    -T SRR21755837 \
    ./results/mpox/primer-trimmed/SRR21755837.primertrimmed.rg.bam \
    -o ./results/mpox/primer-trimmed/SRR21755837.primertrimmed.rg.sorted.bam

samtools index \
    ./results/mpox/primer-trimmed/SRR21755837.primertrimmed.rg.sorted.bam

# count the read alignments belonging to each read group
samtools view \
    ./results/mpox/primer-trimmed/SRR21755837.primertrimmed.rg.sorted.bam | \
    awk '{ print $22 }' | grep 'RG:Z:1' | wc -l -->
